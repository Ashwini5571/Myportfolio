...
export function Education(){
    return(
        <div>
            <p class="text-secondary mt-3 text-center"><b>Check out my Resume</b></p>
            <p class="p1 text-center"><b>Resume</b></p><br/><br/>
            <h2 class="text-light text-center"><b>Education</b></h2><br/>
            <div class="row">
