...
import back from '../Image/nature.png'
export function Aboutme(){
    return(
        <div class="T1">
            <p class="text-light mt-3">Get to me Know</p>
            <p class="p1"><b>About me</b></p>
            <div class="row mt-5">
                <div class="col-md-5">
                    <img src={back} height="500px" width="450px"/>
                </div>
                <div class="col-md-7" align="left">
                    <h4 class="text-success">who am i?</h4>
                    <p class="text-white fs-2"><b>I'm  Ashwini R H, a visual UX/UI Designer and<br/> Web Developer</b></p>
